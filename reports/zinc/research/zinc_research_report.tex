...
\begin{tabular}{rl}\textbf{Data checkpoint:}&15 August 2026\\\textbf{Report date:}&15 August 2026\\\textbf{Status:}&Complete benchmark and three-bubble pipeline\end{tabular}
...
184 certificate trading days, demonstrating why domestic physical basis must be modeled.
...
The current file has 268 calendar rows through 27 August 2026 and 194 positive-trade days.
...
raw CSV has 6,325 rows and 3,512 positive trades through 1405/06/04.
...
collection and parsing use the workspace-wide LME engine with explicit Zinc configuration. Source
missing markers remain raw, and incremental refresh touches only the newest year. The current
LME file contains 4,719 unique dates from 2 January 2008 through 28 August 2026.

Complete IME physical responses are content-addressed once in the shared source archive; Zinc
retains its separate filtered raw CSV and locally explicit grade/benchmark assumptions.

The shared canonical FX file under \code{shared/data/raw/fx} stores IRR/USD. Recent TGJU
observations use daily close; 13,030 historical
midpoint observations remain explicitly labeled legacy. The file contains 13,079 dates through
1405/06/05, including 49 close-based observations.
...
Certificate vs intrinsic&184&$-20.11\pct$&$-18.58\pct$&$-33.91\pct$&$-10.54\pct$&0/184\\
Certificate vs est. physical&178&0.34\pct&1.02\pct&$-19.58\pct$&16.97\pct&102/76\\
Regression sensitivity&184&0.59\pct&2.52\pct&$-16.78\pct$&12.65\pct&106/78\\\bottomrule
...
Figure~\ref{fig:zn-certificate} is negative for every one of the 184 positive-volume
certificate days. Its mean is $-20.11\pct$. Read alone, this chart might suggest a persistent
