...
| `certificate_vs_intrinsic_bubble.csv` | 182 | حباب مستقیم گواهی–ذاتی |
| `zinc_certificate_bubble.csv` | 178 | حباب اصلی درون‌یابی |
| `intrinsic_regression.csv` | 182 | خروجی روش آزمایشی |
...
نمایش می‌دهد. notebook اجرا نشده و هیچ تصویر ذخیره‌شده‌ای تولید نشده است.
